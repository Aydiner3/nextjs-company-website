          ...
          <div className="team-wrapper">
            ...
            >
              <div className="team-title">
                <span>Şirket Kurucu Ortağı</span>
                <h4>
            ...
            >
              <div className="team-title">
                <span>Şirket Kurucu Ortağı</span>
                <h4>
                  <Link href="/team-details">İsmail KARATAŞ</Link>
                </h4>
              </div>
              <p>Emekli Astsubay</p>
              <div
            ...
            >
              <div className="team-title">
                <span>Eğitim Kurumu Yöneticisi</span>
                <h4>
                  <Link href="/team-details">Saadet YAZGAN</Link>
                </h4>
              </div>
            ...
            >
              <div className="team-title">
                <span>Koruma Şirketi Yöneticisi</span>
                <h4>
                  <Link href="/team-details">Mehmet Bilge Sontur</Link>
                </h4>
              </div>
              <p>Emekli Astsubay</p>
              <div
