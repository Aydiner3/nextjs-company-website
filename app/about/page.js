                  ...
                  <div className="col-lg-6 mt-4 mt-lg-0">
                    <div className="about-content">
                      ...
                      <p
                        ...
                        data-wow-delay=".5s"
                      >
                        Modern ,yenilikçi yaklaşımlar ile güvenliği maksimum
                      ...
                      <div className="about-author">
                        ...
                        >
                          ...
                          />
                          <div className="content">
                            <h6>Ahmet Aydın ER - İsmail KARATAŞ</h6>
                            <p>Kurucu</p>
                          </div>
                        </div>
                      </div>
              ...
              <div className="row">
                ...
                >
                  <div className="single-team-items">
                    ...
                    <div className="team-content text-center">
                      <h3>
                        <Link href="#">Saadet YAZGAN</Link>
                      </h3>
                      <p>Eğitim Kurumu Yöneticisi</p>
                    </div>
                  </div>
                </div>
                <div
                ...
                >
                  <div className="single-team-items">
                    ...
                    <div className="team-content text-center">
                      <h3>
                        <Link href="#">Mehmet Bilge SONTUR</Link>
                      </h3>
                      <p>Koruma Şirketi Yöneticisi</p>
                    </div>
                  </div>
                </div>
              </div>
